...
def show_home():
    ...
    with col2:
        st.markdown('### Dataset')
        st.markdown('''The dataset is obtained from a credible source and comprises relevant details regarding various courses. For further information or to access the dataset, please refer to the provided source.''')
